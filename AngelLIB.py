"""
AngelLIB by Valentin Thuillier alias TheAngelLCF
"""
...
class Updater:
    def __init__(self, sftp_server: str, user: str, password: str, dir='', dir_server=''):
...
if __name__ == "__main__" and False:
    ...
    print("Démarrage du test SFTP !")
    download = Downloader("89.86.152.239", '.Test', False, logger=True, sftp=True, user='valjul', password='bp2022pjt', main_dir='test/')
    download.get_recap()
    download.update()
